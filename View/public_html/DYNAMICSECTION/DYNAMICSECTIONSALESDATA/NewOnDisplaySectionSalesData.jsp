...
try{
  ...
  System.out.println("NewOnDisplaySectionSalesData]Sesión a consultar : " + strSessionId);
  PortalSessionBean objSessionBean = (PortalSessionBean)SessionService.getUserSession(strSessionId);
  System.out.println("[NewOnDisplaySectionSalesData]Sesión a consultar : " + objSessionBean);
  ...
  if (strShowDataFields.equals("1")){
      ...
      //-----------------------------------
      hshData= objSalesDataService.getAplicationCustomer(lOrderId,lDivisionId,lCustomerId,Constante.IND_STATUS_ACTIVE);
...
<tr>
   ...
   <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>   
   <td align="right" id="salesdatanew" >
