...
<%	
	...
	RepairService objRepairService = new RepairService();
        ...
        HashMap hshDataMap2 = new HashMap();
	...
	HashMap hshRepairReportMap = objRepairService.getDataLoanForReport(lRepairId);
        ...
        listAccesorry2=(List<String>)hshRepairReportMap.get("resultlistAccessory2");
        ...
        System.out.println("listAccesorry2.size(): "+listAccesorry2.size());
        
        String repairList_defectuoso=""+hshRepairReportMap.get("WN_NP_REPLISTID_1");
        String repairList_prestamo=""+hshRepairReportMap.get("WN_NP_REPLISTID_2");
        String model_defectuoso=""+hshRepairReportMap.get("WV_MODEL_DEFECTUOSO");
        String model_prestamo=""+hshRepairReportMap.get("WV_MODEL_PRESTAMO");
        
	hshDataMap1 = objRepairService.getDamageList(repairList_defectuoso, model_defectuoso);
	hshDataMap2 = objRepairService.getDamageList(repairList_prestamo, model_prestamo);        
        List<EquipmentDamage> repairDamageList = (List<EquipmentDamage>)hshDataMap1.get("resultlist");
	List<EquipmentDamage> repairDamageList2 = (List<EquipmentDamage>)hshDataMap2.get("resultlist");
        
        String imagen1=""+hshDataMap1.get("imagen_equipo");
        String imagen2=""+hshDataMap2.get("imagen_equipo");
        ...
        String si_no_prestamo= (repairList_prestamo==null || repairList_prestamo.equals("")?"NO":"SI");
        
        Gson gson = new Gson();
	String repairDamageListBeansJson = gson.toJson(repairDamageList);
	String repairDamageListBeansJson2 = gson.toJson(repairDamageList2);
        //out.println("prueba0: "+repairDamageListBeansJson);   
    //EPENA 23/07/2015
    GeneralService objGeneralService   = new GeneralService();
    ArrayList arrCondition = objGeneralService.getConditionsReport("REPORT_REPAIR_CON_PRESTAMO");
...
var damageTypes = [
    ...
    $(document).ready(function() {
         ...
         try{
            fillDamages(jsonObject2,damages2);
         }catch(err){
             //console.debug(err);
         }
     });
				...
				<tr>
					<td width="30%">
						<table cellspacing="0" cellpadding="0"
							...
							<tr>
								<td bgcolor="#ED750C" height="10"><font size="2">DATOS DEL
										TERMINAL</font></td>
							</tr>
							<tr>
								<td><font size="2">N° TELEF&Oacute;NICO: <%=hshRepairReportMap.get("WV_PHONE")%></font></td>
							</tr>
							<tr>
								<td><font size="2">FABRICANTE: <%=hshRepairReportMap.get("WV_FABRICATOR")%></font></td>
							</tr>
							<tr>
								<td><font size="2">MODELO: <%=hshRepairReportMap.get("WV_MODEL_DEFECTUOSO")%></font></td>
							</tr>
							<tr>
								<td><font size="2">IMEI: <%=hshRepairReportMap.get("WV_IMEI_DEFECTUOSO")%></font></td>
							</tr>
							<tr>
								<td><font size="2">N° SIM CARD: <%=hshRepairReportMap.get("WV_SIM")%></font></td>
							</tr>
							<tr>
								<td><font size="2">GARANT&Iacute;A DE FABRICA: <%=hshRepairReportMap.get("WV_WARRANTY_FACTORY")%></font></td>
							</tr>
						</table>
					</td>
					<td width="30">&nbsp;</td>
					<td width="20%" height="100%">
						<table cellspacing="0" cellpadding="0"
							style="border: 1px solid black;" width="100%" height="100%">
							<tr>
								<td bgcolor="#ED750C" align="center"><font size="2">ACCESORIOS</font>
								</td>
							</tr>
                                                        <%	
					...
					<td width="50%">
						<table cellspacing="0" cellpadding="0"
							style="border: 1px solid black" width="100%" height="100%">
							<tr>
								<td bgcolor="#ED750C" align="center"><font size="2">DETALLE F&Iacute;SICO DEL EQUIPO</font></td>
							</tr>
							<tr>
								<td height="100%">                                                                
						...
						<table width="100%" height="100%">
							<tr>
								<td width="60%" valign="top">
									<table width="100%" cellspacing="0" cellpadding="0"
										style="border: 1px solid black;" height="70%">
										<tr>
											<td bgcolor="#ED750C" style="border: 1px solid black;"><font
												size="2"> REPARACI&Oacute;N EN GARANT&Iacute;A </font></td>
											<td bgcolor="#ED750C" style="border: 1px solid black;" align="center"><font
												size="2">&nbsp;<%=hshRepairReportMap.get("WV_GARANTIA_REPARACION")%> </font></td>
										</tr>
										<tr>
											<td bgcolor="#ED750C" style="border: 1px solid black;"><font
												size="2"> REEMPLAZO </font></td>
											<td bgcolor="#ED750C" style="border: 1px solid black;" align="center"><font
												size="2"> <%=si_no_reemplazo%> </font></td>
										</tr>
										<tr>
											<td colspan="2"><font size="2">FAB: <%=hshRepairReportMap.get("WV_FAB_REEMPLAZO")%></font></td>
										</tr>
										<tr>
											<td colspan="2"><font size="2">MODELO: <%=hshRepairReportMap.get("WV_MODEL_REEMPLAZO")%></font></td>
										</tr>
										<tr>
											<td colspan="2"><font size="2">IMEI: <%=hshRepairReportMap.get("WV_IMEI_REEMPLAZO")%></font></td>
										</tr>
									</table>
								</td>
								<td width="30">&nbsp;</td>
								<td width="40%" height="100%" valign="top">
									<table width="100%" cellspacing="0" cellpadding="0"
										style="border: 1px solid black;" height="90%">
										<tr>
											<td bgcolor="#ED750C" style="border: 1px solid black;"><font
												size="2"> PR&Eacute;STAMO </font></td>
											<td bgcolor="#ED750C" style="border: 1px solid black;" align="center"><font
												size="2"> <%=si_no_prestamo%> </font></td>
										</tr>
										<tr>
											<td bgcolor="#ED750C" align="center" colspan="2"
												style="border: 1px solid black;"><font size="2">
													ACCESORIOS </font></td>
                                                                                ...
                                                                                <%	
                                                                                        if(listAccesorry2!=null && listAccesorry2.size()>0){
                                                                                        int i=0;
                                                                                        String altura="";
                                                                                                for(String str:listAccesorry2){
                                                                                                        i++;
                                                                                                        %>
                                                                                                        <tr>
                                                                                                                <td><font size="2"><%=str%></font></td>
						...
						<table width="100%" cellspacing="0" cellpadding="0"
							...
							<tr>
								<td bgcolor="#ED750C" align="center"><font size="2">DETALLE F&Iacute;SICO
										DEL EQUIPO (PR&Eacute;STAMO)</font></td>
							</tr>
							<tr>
								<td height="100%">
                                                                <table align="center" class="RegionBorder" style="border-collapse: collapse" cellspacing="1" cellpadding="1" width="365">
                                                                    ...
                                                                    <tr>
                                                                            <td colspan="5"><div id="divImage2"></div></td>
                                                                            <td class="CellContent" width="27%"><div id="divCaption2"></div></td>
                                                                    </tr>
                                                                </table>
                                                                </td>
							</tr>
