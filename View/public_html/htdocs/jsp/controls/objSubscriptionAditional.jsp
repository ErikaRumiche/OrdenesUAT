...
/*Recuperando Parametros de Input*/
  ...
  //DLAZO - PRUEBA DE FILTRADO DE SUSCRIPCIONES
         ...
         <div id="services">
            ...
            <table border="0" cellspacing="0" cellpadding="0" id="tbCabeceraServiciosAdicionales">
              <tr class="PortletHeaderColor">
                 ...
                 <td class="SubSectionTitle" align="left" valign="top">Suscripciones <a href="javascript:fxShowSuscripActivas()">
                  <img src="<%=Constante.PATH_APPORDER_SERVER%>/images/viewDetail.gif" alt="Suscripciones activas" width="15" height="15" border="0"/></a></td>
                 <td class="SubSectionTitleRightCurve" valign="top" align="right" width="12"></td>
                 <script type="text/javascript">
                  function fxShowSuscripActivas() {
                    ...
                    if (txt_ItemPhone != "") {
                      if(txt_ItemImei != ""){
                        var url = "<%=request.getContextPath()%>/htdocs/jsp/controls/POPUP/popUpDetailSuscripActivas.jsp?txt_ItemPhone="+txt_ItemPhone+"&strCodigoCliente="+<%=strCodigoCliente%>+"&hdnSpecification="+<%=hdnSpecification%>+"&strOrderId="+<%=strOrderId%>+"&strSideId="+<%=strSideId%>;
                        WinAsist = window.open(url,"SuscripActivas","toolbar=no,location=0,directories=no,status=yes,menubar=0,scrollbars=no,resizable=yes,screenX=100,top=80,left=150,screenY=80,width=700,height=250,modal=yes");
                      }
                    }else {
