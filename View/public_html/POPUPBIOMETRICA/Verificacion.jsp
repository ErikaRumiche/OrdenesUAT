...
<%
    ...
    if(ArrayDatos.length>=7){strdocument=ArrayDatos[6];}
                ...
                <td>
                    <table align="center" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="Rut" id="Rut" onkeypress="return NumCheck(event, this)"  align="left" class="CellContent" />
                                <input type="hidden"  id="hdflagDni"    name= "hdflagDni" value="0"   />
                            </td>
                            <% }else{ %>
                            <td><input type="text" name="Rut" id="Rut" value="<%=strdocument%>" align="left" class="CellContent" readonly />
...
<script type="text/javascript">
    ...
    function verifPendiente(){
        ...
        if(validarDocumento()){
            ...
            var server='<%=strURLBiometricaEditServlet%>';
            var params = 'myaction=verifPendiente&order='+order+'&selectAccion='+selectAccion+'&documento='+documento+'&accionNoBiometrica='+accionNoBiometrica;
            $.ajax({
                url: server,
                data: params,
                type: "POST",
