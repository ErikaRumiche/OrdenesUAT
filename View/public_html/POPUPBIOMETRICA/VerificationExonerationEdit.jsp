...
<%
    System.out.println("INICIO SESSION - VerificationExonerationEdit");
    ...
    if(ArrayDatos.length>=7){
        strTypeDocument=MiUtil.getString(ArrayDatos[6]);
    }
    if(ArrayDatos.length>=8){
        strTypeDocumentValue=MiUtil.getString(ArrayDatos[7]);
    }
    //JVERGARA [PRY-0787] fin
                ...
                <td>
                    <table align="center" width="100%" border="0">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="Rut" id="txtNumDoc"  align="left" class="CellContent" />
