...
public class CustomerServlet extends GenericServlet {
     ...
     if ( MiUtil.parseInt((String)hshCustPattern.get("wn_customer_qty")) == 1 && (  (strGeneratortype.equals(Constante.GENERATOR_TYPE_OPP))|| (MiUtil.parseInt((String)hshValidationCustomer.get("respuesta"))== 1 ) ) ) {         
        ...
        if( hshCutomer != null ){
          ...
          if( (String)hshCutomer.get("strMessage") != null ) {
            ...
            //Se agrego la validacion de Ubigeo
            String mensaje = validateUbigeo(hshCutomer,"CUSTOMER",request);
  ...
  */
   ...
   public void showCustomerDetail(HashMap hshCustomer, HttpServletRequest request, PrintWriter out) throws Exception {
     ...
     if( hshCustomer != null) {
        ...
        if (hshCustomer.size()!=0) {
          ...
          wv_nptipodoc        = (String)hshCustomer.get("wv_nptipodoc"); 
          
          wv_billcycle =  (String)hshCustomer.get("wv_billcycle");
            ...
            if ( ! strCodigoCliente.equals("0") ) {
                ...
                if(hd.size()!=0) {
                  if( !(hd.get("wn_valorTotalGarantia")+"").equals("0") ) {
					  if(hd.get("wn_valorTotalGarantia") == null){
	                	  if(wv_nptipodoc.equals(TIPO_DOC_RUC)){
	                		  hd.put("wn_valorTotalGarantia","10");  
	                		}else {
	                		  hd.put("wn_valorTotalGarantia","1");
	                	  } 
					  }
                	  ...
                	  if(wv_nptipodoc.equals(TIPO_DOC_RUC)){
                		  out.println("parent.mainFrame.divCustValue.innerHTML = \"<img src='"+Constante.PATH_APPORDER_SERVER+"/images/CustValue/CustValue10.gif' border=0 align='absbottom'>\" ;");  
                		}else {
                      	  out.println("parent.mainFrame.divCustValue.innerHTML = \"<img src='"+Constante.PATH_APPORDER_SERVER+"/images/CustValue/CustValue1.gif' border=0 align='absbottom'>\" ;");
                		}  
                  }
                }
           }
         ...
         // clearCustomer(request,out);
          ...
          if (  !MiUtil.getString(strVendedor).equalsIgnoreCase("")   ){            
            ...
            String strGeneratortype  = request.getParameter("hdngeneratortype");  /**INICIO ADT-BCL-083 -- LHUAPAYA*/
            System.out.println("[CustomerServlet][showCustomerDetail][strRegionId]"+strGeneratortype);
            if(strGeneratortype != null && strGeneratortype.trim().equals(Constante.SPEC_TYPE_BOLSA)){
                if(wv_swtype.toLowerCase().equals("customer")){
          ...
          out.println("if (form.hdnDocument!=null)         form.hdnDocument.value         = '" + wv_swruc+ "';");
          ...
          out.println("if (form.cmbVendedor!=null)         AddNewOption(form.cmbVendedor, '" + wn_vendedorid + "', '" + wv_vendedorname + "');");
          ...
          out.println("if (form.cmbVendedor!=null)         form.txtCmbVendedor.value      = '" + wv_vendedorname + "';");
          ...
          out.println("if (form.hdnTypeDocument!=null)     form.hdnTypeDocument.value      = '" + wv_nptipodoc+ "';");  
          out.println("if (form.hndBillcycle!=null)     form.hndBillcycle.value      = '" + wv_billcycle+ "';");
         ...
         setControlsByParamaters(request,out,strCodigoCliente);
                    ...
                    out.println("alert('El cliente elegido no es de tipo Customer')");
   ...
   */    
   public void getShowAddress(String strCodigo, long longRegionId , String strTipoObjeto, HttpServletRequest request, PrintWriter out) throws Exception {
        ...
        objHashMap =  objCustomerService.CustomerDAOgetCustomerAddress(MiUtil.parseInt(strCodigo),longRegionId,strTipoObjeto,strGeneratortype);
         ...
         for( int i=0; i<lista_direcciones.size();i++ ){
              ...
              if ("1".equals(strFlagDefault)&&("".equals(strAux))){
                    ...
                    out.println("col.align = 'center';");
                       out.println("col.innerHTML = \"<a href=javascript:fxShowAdress();>" + h.get("wv_swtipodirec") + "</a>&nbsp;&nbsp;<a href=javascript:fxEditShippingAddress();><img src='"+Constante.PATH_APPORDER_SERVER+"/images/Editar.gif' border=0 align='absbottom'></a>\";");
                                    
                    strAux = "entro";

                    out.println("frmdatos.txtReference.value = '" + MiUtil.getMessageClean(h.get("wv_swreference").toString())+"'"); //EPV
                    ...
                    out.println("frmdatos.txtReference.value = ''"); //EPV
                  }
              }else{
                 // INI SP3103 VALIDACION DE DIRECCIONES FRAUDULENTAS
                  String dirAux1 = "<input type=hidden name=address1 value= \"" + MiUtil.getMessageClean(h.get("wv_swaddress1").toString())+ "\" >";
                  String dirAux2 = "<input type=hidden name=address1CmbId value= \"" + MiUtil.getMessageClean(h.get("wv_swcityid").toString())+ "\" >";    
                  out.println("col.innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + MiUtil.getMessageClean(h.get("wv_swaddress1").toString()) + dirAux1+ dirAux2+"';");
                  // FIN SP3103 VALIDACION DE DIRECCIONES FRAUDULENTAS
              out.println("col = row.insertCell(1);");
              out.println("col.className = 'CellContent';");
              out.println("col.align = 'left';");       
  ...
  */
  public void getShowSiteData (String strCodigoSite, HttpServletRequest request, PrintWriter out)  throws Exception {
    ...
    //MSOTO 03-06-2014 SAR N_O000029100 txtCmbVendedor reemplaza al cmbVendedor
    out.println("AddNewOption(form.cmbVendedor,   '" + hshSiteData.get("wn_vendedorid") + "', '" + hshSiteData.get("wv_vendedorname") + "');");
	...
	//MSOTO 03-06-2014 SAR N_O000029100 txtCmbVendedor reemplaza al cmbVendedor
    out.println("form.txtCmbVendedor.value      = '" + hshSiteData.get("wv_vendedorname") + "';");
  ...
  public void setControlsByParamaters(HttpServletRequest request, PrintWriter out,String strCodigoCliente) throws Exception {    
    ...
    * Validacion propia de bolsa de celulares
    * */
        if(request.getParameter("hdnGeneratorType") != null){
            if(MiUtil.getString(request.getParameter("hdnGeneratorType")).trim().equals(Constante.SPEC_TYPE_BOLSA)){
  ...
  /**
    ...
    //tipo CUSTOMER
    public String validateUbigeo(HashMap hshCutomer,String tipo,HttpServletRequest request){
      ...
      if(hshCutomer != null) {
         ...
         if(hshCutomer.get("wv_swregionid") != null && hshCutomer.get("wn_swcustomerid") != null) {
         
            long wn_regionid = MiUtil.parseLong((String)hshCutomer.get("wv_swregionid"));
            String  wn_swcustomerid = MiUtil.parseInt((String)hshCutomer.get("wn_swcustomerid"))+"";
       
            HashMap objHashMap =  objCustomerService.CustomerDAOgetCustomerAddress(MiUtil.parseInt(wn_swcustomerid),wn_regionid,tipo,strGeneratortype);
            ArrayList lista_direcciones = (ArrayList)objHashMap.get("objArrayList");
      
            if(lista_direcciones != null) {
      
              if(lista_direcciones.size() > 0) {
                 
               for(int i=0; i<lista_direcciones.size();i++ ) {
                   
                   HashMap h = (HashMap)lista_direcciones.get(i);
                   String direccion = h.get("wv_swtipodirec").toString();
                     
                   if(direccion.equals(Constante.DIR_ENTREGA) ) {
                    
                     CustomerService objCustomerService = new CustomerService();
                     
                     String state = MiUtil.getMessageClean(h.get("wv_swstate").toString());              
                     String province = MiUtil.getMessageClean(h.get("wv_swprovince").toString());
                     String city = MiUtil.getMessageClean(h.get("wv_swcity").toString());
                     
                     HashMap map = objCustomerService.validateUbigeo(state,province,city);
                   
                     String result = "";
                     
                     if(map.get("strMessage") != null) {
                     
                        result = map.get("strMessage").toString();
                     ...
                     String strFlagDefault = h.get("wv_swflagaddress").toString();   
                     
                     if(strFlagDefault.equals("1")) {
                         
                        if(result.equals("")) {//Es incorrecto
                                    
                           mensaje = "El ubigeo de la dirección de entrega es incorrecta, reviselo ...";
