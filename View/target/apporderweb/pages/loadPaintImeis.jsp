...
<%
 ...
 try{
  ...
  String strFlgProductGN  =   (request.getParameter("strFlgProductGN")==null?"":request.getParameter("strFlgProductGN"));
  ...
  System.out.println("[loadPaintImeis.jsp]strPhoneNumber   : "+strPhoneNumber);//Reserva de Numeros Golden - RHUACANI-ASISTP - 24/10/2010
  ...
  System.out.println("[loadPaintImeis.jsp][Se comprueba si el producto es un KIT]");
    ...
    if( hshItemDeviceMap.get("strMessage")==null || MiUtil.getString((String)hshItemDeviceMap.get("strMessage")).equals("PRODUCT.SPI_GET_KIT_DET : ORA-01403: no data found") ){
         ...
         %>
            for(j=0; j < <%=intQuantity%>; j++){
              ...
              %>
                ...
                parent.mainFrame.fxAddRowTableImeis("table_imeis",vctItemsImei.elementAt(0),9,-1);
        ...
        System.out.println("Exception : Problemas al mostrar ITEM_DEVICE -> " + (String)hshItemDeviceMap.get("strMessage") );
      %>
