...
%>
<iframe name="searchFrame" src ="<%=request.getContextPath()%>/reports/suspPCMForm.jsp?hdnLogin=<%=portalSessionBean.getLogin()%>" width="100%" height="800" frameborder="0" marginheight="3" marginwidth="3">
<%--<iframe name="searchFrame" src ="<%=request.getContextPath()%>/reports/suspPCMForm.jsp?hdnLogin=JHERRERA" width="100%" height="800" frameborder="0" marginheight="3" marginwidth="3">--%>
</iframe>
<%      
