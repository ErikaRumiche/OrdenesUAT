...
<%
    System.out.println("--------- ORDER_COMPANIABUSCARLISTA.JSP ---------");
    ...
    strSessionCode =(request.getParameter("hdnSessionCode")==null?"":request.getParameter("hdnSessionCode"));
    ...
    System.out.println("[Inicio - Order_CompaniaBuscarLista.jsp]");
...
<head>
    ...
    <script language="javascript" DEFER>
        ...
        function goToOtherSearch() {
            var strParam="";
            var strURL="";
            strParam="?hdnSessionLevel="+"<%=intSessionLevel%>"+"&hdnSessionCode="+"<%=strSessionCode%>"+"&hdnSessionLogin="+"<%=hdnSessionLogin%>"+"&hdnProGrpId="+"<%=intProGrpId%>"+"&hdnIUserId="+"<%=iUserId1%>"+"&hdnIAppId="+"<%=iAppId1%>";
            strURL="Order_CompaniaBuscar.jsp"+strParam
            window.location=strURL;
        }

        /*Developer : Lee Rosales*/
        function fxSelectCompanyId(idCompany){
            var url = "<%=request.getContextPath()%>/customerservlet?myaction=buscarCliente&detallemyaction=id&hdnSessionLogin="+'<%=hdnSessionLogin%>'+"&hdnCustId="+idCompany;
            vDocForm  = parent.opener.parent.mainFrame.frmdatos;
            vDocForm.action = '<%=request.getContextPath()%>/customerservlet';
...
<script type="text/javascript">
    function paginar(numPagina) {
        ...
        parametros += "&hdnIUserId=<%=iUserId1%>";
        parametros += "&hdnIAppId=<%=iAppId1%>";

        cadena = "<%=request.getContextPath()%>/htdocs/jsp/Order_CompaniaBuscarLista.jsp?"+"&d-447055-p="+numPagina;
        cadena += parametros;
...
<%
        ...
        System.out.println("INGRESO NO AUTORIZADO A ORDER_COMPANIABUSCARLISTA.JSP");
