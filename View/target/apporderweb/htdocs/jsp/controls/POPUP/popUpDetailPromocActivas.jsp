...
try {
  ...
  strOrderId              =   MiUtil.getString((String)request.getParameter("strOrderId"));
  ...
  hshSubscripActive = (HashMap)objGeneralService.getServiceActive(strTelefono,MiUtil.parseLong(strCustomerId),MiUtil.parseLong(hdnSpecification),MiUtil.parseLong(strnpSite),MiUtil.parseLong(strOrderId));
...
<title>Consulta de Promociones Activas para el teléfono: <%=strTelefono%> </title>

  <table border="0" cellspacing="0" cellpadding="0">
    <tr class="PortletHeaderColor">
       <td class="SubSectionTitleLeftCurve" valign="top" align="left" width="16"></td>
       <td class="SubSectionTitle" align="LEFT" valign="top" width="230px">Promociones Activas - N° <%=strTelefono%></td>
    ...
    <tr>
       <td class="RegionHeaderColor" width="100%">
          <table cellpadding="2" cellspacing="1" border="0" width="100%" align="center">
             <tr>
                <td class="CellLabel" valign="TOP" width="5%" align="center" ><b>N°</b></td>
