       ...
       <input type="hidden" name="hdnFlag" value="0">   <!-- HME COR0536 -->	 
          ...
          <table  border="0" width="100%" cellpadding="2" cellspacing="1">              
                 ...
                 <tr>                  
                     ...
                     <input type="text" name="txtNumTelefono" size="7" maxlength="8" onBlur="javascript:fxValidatePhone(this,'Área/Teléfono');"  >
  ...
  function fxValidatePhone(obj, str){
   ...
   function fxSearchAreaCode(code, nAreaCode ,nAreaNom, ntelf){
    ...
    /*  var billaccid =0;
      ...
      if (billaccid<=0 )
         alert("Se produjo un error al intetar generar el código para el site, intente nuevamente");*/
