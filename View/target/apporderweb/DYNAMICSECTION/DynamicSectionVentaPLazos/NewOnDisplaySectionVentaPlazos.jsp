...
try{
   ...
   if ( hshtinputNewSection != null ) {
      ...
      System.out.println("VEP strSalesStuctOrigenId: " + strSalesStuctOrigenId);
   } 
				...
				<tr>
                    ...
                    <td class="CellContent" align="center">
                        ...
                        <table  border="0" cellspacing="1" cellpadding="1" align="center" class="BannerSecondaryLink" width="100%">
                            ...
                            <tr>
                                <td class="CellContent" align="center">
                                    <input type="input" id="txtCuotaInicial" name="txtCuotaInicial" disabled="true"  onblur="return validateKeyUp(this,event);"  onkeypress="return validateFloatKeyPress(this,event);" />
                                </td>
                                <td class="CellContent" align="center">
					...
					<td class="CellContent">
						<select id="cmbVepNumCuotas" name="cmbVepNumCuotas" style="width: 75%" onclick="fxSaveIndexComboCuota(this)" onchange="fxValidateNumeroCuotas(this, 0)">
            <option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
						<% 
